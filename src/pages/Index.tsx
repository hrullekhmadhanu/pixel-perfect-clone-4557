...
<section className="bg-orange-50 py-12 md:py-20 px-1 md:px-6">
  <div className="container mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
    ...
    <div className="relative">
      ...
      {/* Top Right Overlay - 50K+ Happy Smiles */}
      <div className="absolute -top-2 md:-top-4 -right-2 md:-right-4 bg-white rounded-2xl shadow-lg p-3 md:p-4 flex items-center gap-2 md:gap-3 border border-gray-100">
        <div className="flex items-center gap-1 md:gap-2">
          <div className="w-8 md:w-10 h-8 md:h-10 bg-orange-100 rounded-full flex items-center justify-center text-sm md:text-base">
            😊
          </div>
          <div className="w-6 md:w-8 h-6 md:h-8 bg-blue-100 rounded-full flex items-center justify-center text-sm md:text-base">
            👍
          </div>
        </div>
        <div>
          <div className="text-xl md:text-2xl font-bold text-gray-800">50K+</div>
          <div className="text-xs md:text-sm text-gray-600">Happy Smiles</div>
        </div>
      </div>
      
      {/* Bottom Left Overlay - Patients Feedback */}
      <div className="absolute -bottom-2 md:-bottom-4 -left-2 md:-left-4 bg-white rounded-2xl shadow-lg p-3 md:p-4 border border-gray-100">
        <div className="text-xs md:text-sm font-medium text-gray-700 mb-2">Patients Feedback</div>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs md:text-sm font-medium text-gray-700">Review 5.0/5.0</span>
        </div>
      </div>
      
      {/* Decorative tooth icon */}
      <div className="absolute bottom-6 md:bottom-8 right-6 md:right-8 text-gray-300 text-4xl md:text-6xl opacity-20">
        🦷
      </div>
    </div>
  </div>
          ...
          <div className="relative z-10 flex-1">
            ...
            <div className="flex flex-wrap gap-3">
              {service.tags.map(tag => (
                <span
                  key={tag}
                  className="px-4 py-2 rounded-full border border-primary/30 text-primary text-sm md:text-base font-normal backdrop-blur group-hover:border-white/50 group-hover:text-white group-active:border-white/50 group-active:text-white transition-all duration-300"
