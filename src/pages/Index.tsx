...
<section className="bg-gradient-to-br from-primary-light to-background py-20 px-6">
  <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
    ...
    <div className="relative">
      ...
      <div className="absolute -top-4 -right-4 bg-white rounded-2xl shadow-lg p-4 flex items-center gap-3 border border-gray-100">
        <div className="flex items-center gap-2">
      ...
      <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-lg p-4 border border-gray-100">
        <div className="text-sm font-medium text-gray-700 mb-2">Patients Feedback</div>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-gray-700">Review 5.0/5.0</span>
        </div>
      </div>
      
      {/* Decorative tooth icon */}
      <div className="absolute bottom-8 right-8 text-gray-300 text-6xl opacity-20">
        🦷
      </div>
    </div>
  </div>
      ...
      {/* Services Section */}
<section className="relative bg-[#D789FE] py-16 px-2 rounded-b-[70px] md:px-4">
  {/* Inner light red container with rounded bottom corners */}
  <div className="bg-accent-pink py-16 px-6 rounded-b-[70px] max-w-6xl mx-auto">
    ...
    <div className="flex justify-center mt-10">
      <button
        className="border-2 border-accent-pink-foreground rounded-full px-8 py-3 text-base flex items-center gap-3 bg-transparent hover:bg-white/20 focus:outline-none transition-all duration-200 text-accent-pink-foreground hover:text-white"
      >
        View More Services
        <svg
          className="w-5 h-5"
