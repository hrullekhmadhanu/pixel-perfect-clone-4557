  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "rise-up-delay-1": "rise-up 0.8s ease-out 0.1s both",
        "rise-up-delay-2": "rise-up 0.8s ease-out 0.2s both",
        "rise-up-delay-3": "rise-up 0.8s ease-out 0.3s both",
      },
    },
  },
